...
describe ('#transformPhotoObj()', function() {
  it('should take a photo object and return an object with just the title and the URL', function () {
    var input = {
      id:       '25373736106',
      owner:    '99117316@N03',
      secret:   '146731fcb7',
...
describe('#fetchPhotos()', function() {
  it(
    'should take an API key and fetcher function and return a promise for transformed photos', function() {
      var apikey = 'does not matter what this is right now',
      expected = [{
        title:  'Dog goes to desperate measure to avoid walking on a leash',
        url:    'https://farm2.staticflickr.com/1669/25373736106_146731fcb7_b.jpg'
